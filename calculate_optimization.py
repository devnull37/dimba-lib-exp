...
def calculate_memory_usage():
    ...
    mamba_params_per_layer_1_5b = d_model_1_5b * d_model_1_5b * expand + d_model_1_5b * d_state + d_model_1_5b * d_conv
    ...
    total_memory_1_5b = model_memory_1_5b * 4 + hidden_memory_1_5b  # model + grad + optimizer * 2
